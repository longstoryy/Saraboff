...
const managerNav = [
    ...
    { href: "/users", emoji: "⬛", label: "Users", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v2h5M7 20v-2a3 3 0 015.356-1.857M7 20H2m5 0v-2m5.356-1.857A3 3 0 0012 14a3 3 0 00-2.644 1.857" },
];
const attendantNav = managerNav.filter(n => n.href !== "/users");
